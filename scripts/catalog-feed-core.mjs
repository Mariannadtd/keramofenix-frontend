...
export const staticSeoRoutes = [
  ...
  },
  {
    ...
    seoHeading: "Адреса салонов КерамоФеникс в Сочи",
    seoParagraphs: [
      "КерамоФеникс работает ежедневно с 9:00 до 21:00. В салонах на ул. Гагарина, 63 и ул. Донская, 3/3 можно посмотреть образцы дверей, керамогранита, напольных покрытий и фурнитуры.",
      "Перед визитом можно позвонить по телефону +7 988 406-88-87 или написать в WhatsApp, чтобы уточнить наличие, цену, доставку, замер и комплектацию материалов для ремонта.",
    ],
    changefreq: "monthly",
    priority: "0.7",
  },
  {
    ...
    seoHeading: "Правила возврата и обмена товаров",
    seoParagraphs: [
      "Возврат или обмен товара надлежащего качества возможен в сроки, установленные законодательством РФ, если товар не устанавливался, сохранены упаковка, товарный вид, комплектность и документы, подтверждающие покупку.",
      "При браке или повреждениях покупателю нужно связаться с КерамоФеникс, направить данные заказа, описание проблемы и фотографии. После проверки обращения магазин предложит замену, устранение недостатков или возврат денежных средств.",
    ],
    changefreq: "monthly",
    priority: "0.5",
  },
